...
class HubertModel(HubertModel):
    ...
    def forward(self, input_values, output_fps=30, attention_mask=None, output_attentions=None,
        ...
        if frame_num is not None:
            extract_features_len = round(frame_num * 30 / output_fps)
            extract_features = extract_features[:, :, :extract_features_len]
        extract_features = linear_interpolation(extract_features, 30, output_fps, output_len=frame_num)
