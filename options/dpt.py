...
def add_model_options(parser: argparse.ArgumentParser):
    ...
    parser.add_argument('--n_diff_steps', type=int, default=1000, help='number of diffusion steps')
    ...
    parser.add_argument('--d_style', type=int, default=512, help='dimension of the style feature')
    ...
    parser.add_argument('--feature_dim', type=int, default=768, help='dimension of the hidden feature')
    parser.add_argument('--n_heads', type=int, default=8, help='number of attention heads')
    #parser.add_argument('--n_heads', type=int, default=16, help='number of attention heads')
    #parser.add_argument('--n_layers', type=int, default=16, help='number of encoder/decoder layers')
    ...
    # sequence
    #parser.add_argument('--n_motions', type=int, default=60, help='number of motions in a sequence')
    parser.add_argument('--n_motions', type=int, default=28, help='number of motions in a sequence')
    parser.add_argument('--n_prev_motions', type=int, default=4, help='number of pre-motions in a sequence')
...
def add_training_options(parser: argparse.ArgumentParser):
    ...
    parser.add_argument('--max_iter', type=int, default=400000, help='max number of iterations')
    ...
    parser.add_argument('--l_vert', type=float, default=0, help='weight of the vertex loss')
    parser.add_argument('--l_vel', type=float, default=0, help='weight of the velocity loss')
    parser.add_argument('--l_smooth', type=float, default=0,
                        help='weight of the vertex acceleration regularization')
    parser.add_argument('--l_trans', type=float, default=0)
    parser.add_argument('--l_head_angle', type=float, default=0, help='weight of the head angle loss')
    parser.add_argument('--l_head_vel', type=float, default=0, help='weight of the head angular velocity loss')
    parser.add_argument('--l_head_smooth', type=float, default=0,
                        help='weight of the head angular acceleration regularization')
    parser.add_argument('--l_head_trans', type=float, default=0,
